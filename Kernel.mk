...
TARGET_PREBUILT_KERNEL := device/khadas/a95f1/prebuilt/Image.gz
LOCAL_DTB := device/khadas/a95f1/prebuilt/a95f1.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/khadas/a95f1/prebuilt/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/a95f1/prebuilt/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/khadas/a95f1/prebuilt/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/a95f1/prebuilt/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/a95f1/prebuilt/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/khadas/a95f1/prebuilt/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/khadas/a95f1/prebuilt/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
